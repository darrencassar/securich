...
if [ $? == 0 ]; then
{
    echo -e "ERROR - Test4 - Peter can show databases after revoke"
} fi


echo ""
echo -e `date` - "INFO - Test4 - Peter can't show databases after revoke"
echo ""
...
if [ $? == 0 ]; then
{
    echo -e "ERROR - Test4 - select now() shouldn't be permitted with revoked rights"
} fi

echo ""
echo -e `date` - "INFO - Test4 - Peter can't show time after revoke"
echo ""
echo ""
